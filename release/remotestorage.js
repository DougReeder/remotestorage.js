...
class GoogleDrive extends remote_1.RemoteBase {
    constructor(remoteStorage, clientId) {
        ...
        script1.onerror = (evt) => {
            console.error('Could not load Google API', evt === null || evt === void 0 ? void 0 : evt.message, evt === null || evt === void 0 ? void 0 : evt.error);
            this.rs._emit('error', new Error('Could not load Google API: ' + (evt === null || evt === void 0 ? void 0 : evt.message)));
        };
        ...
        script2.onerror = (evt) => {
            console.error('Could not load Google Identity Service', evt === null || evt === void 0 ? void 0 : evt.message, evt === null || evt === void 0 ? void 0 : evt.error);
            this.rs._emit('error', new Error('Could not load Google Identity Service: ' + (evt === null || evt === void 0 ? void 0 : evt.message)));
        };
    ...
    createPicker() {
        ...
        this.tokenClient.callback = (response) => __awaiter(this, void 0, void 0, function* () {
